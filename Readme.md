...
- In order for CMake to detect your source files (.cpp) you must include them in the **app_src.cmake** file which is located in the **is-Engine-Level-Editor/app/src/main/cmake** location.
...
#### All
3. Or open the **is-Engine-Level-Editor/app/src/main** folder with **Solution Explorer**.
...
```
2. Or open the file **is-Engine-linux.cbp** in the location **is-Engine-Level-Editor/app/src/main**.
