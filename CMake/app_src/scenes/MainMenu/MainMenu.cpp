...
MainMenu::MainMenu(sf::RenderWindow &window, sf::View &view, sf::RenderTexture &surface, GameSystemExtended &gameSysExt):
...
//////////////////////////////////////////////////////////////////////////////////////////////////////
                    ...
                    if ((m_gameSysExt.isPressed() && mouseInCollisonPad) && (m_waitTime == 0 && !m_gameSysExt.m_keyIsPressed))
                    {
                        ...
                        case OP_START_GAME:
                            playSelectSnd();
                            m_gameSysExt.m_launchOption = GameSystemExtended::DisplayOption::LEVEL_EDITOR;
                            m_isClose = true;
                        break;
