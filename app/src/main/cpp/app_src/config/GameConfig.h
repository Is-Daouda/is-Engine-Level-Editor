...
namespace GameConfig
{
    ...
    static const sf::Color &DEFAULT_SFML_SELECTED_TEXT_COLOR       = sf::Color::Black;
    ...
    static const sf::Color &DEFAULT_RPG_DIALOG_TEXT_COLOR          = sf::Color::Black;
    static const sf::Color &DEFAULT_RPG_DIALOG_SELECTED_TEXT_COLOR = sf::Color::Blue;
    static const sf::Color &DEFAULT_BUTTON_TEXT_COLOR              = sf::Color::Black;
    ...
    static std::string const GAME_NAME     = "is::Engine Level Editor"; ///< Windows title name
