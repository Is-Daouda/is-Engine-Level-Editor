...
namespace GameConfig
{
    ...
    static const sf::Color DEFAULT_SFML_TEXT_COLOR = sf::Color::Black;
    static const sf::Color DEFAULT_SFML_SELECTED_TEXT_COLOR = sf::Color::Blue;
    ...
    static const std::wstring MINOR = L"2"; ///< Game minor version
